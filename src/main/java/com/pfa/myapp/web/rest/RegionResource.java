...
import com.pfa.myapp.service.RegionService;
...
/**
 * REST controller for managing {@link com.pfa.myapp.domain.Region}.
 */
@RestController
@RequestMapping("/api")
public class RegionResource {
    ...
    public ResponseEntity<RegionDTO> updateRegion(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, regionDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<RegionDTO> partialUpdateRegion(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, regionDTO.getId())
        );
    }
