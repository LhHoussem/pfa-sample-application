...
/**
 * REST controller for managing {@link com.pfa.myapp.domain.Country}.
 */
@RestController
@RequestMapping("/api")
public class CountryResource {
    ...
    public ResponseEntity<CountryDTO> updateCountry(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, countryDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<CountryDTO> partialUpdateCountry(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, countryDTO.getId())
        );
    }
