...
import com.pfa.myapp.service.JobHistoryService;
...
/**
 * REST controller for managing {@link com.pfa.myapp.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
public class JobHistoryResource {
    ...
    public ResponseEntity<JobHistoryDTO> updateJobHistory(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, jobHistoryDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<JobHistoryDTO> partialUpdateJobHistory(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, jobHistoryDTO.getId())
        );
    }
    ...
    public ResponseEntity<JobHistoryDTO> getJobHistory(@PathVariable String id) {
