...
import com.pfa.myapp.repository.DepartmentRepository;
import com.pfa.myapp.service.DepartmentService;
...
/**
 * REST controller for managing {@link com.pfa.myapp.domain.Department}.
 */
@RestController
@RequestMapping("/api")
public class DepartmentResource {
    ...
    public ResponseEntity<DepartmentDTO> updateDepartment(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, departmentDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<DepartmentDTO> partialUpdateDepartment(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, departmentDTO.getId())
        );
    }
