...
import com.pfa.myapp.repository.JobRepository;
import com.pfa.myapp.service.JobService;
...
/**
 * REST controller for managing {@link com.pfa.myapp.domain.Job}.
 */
@RestController
@RequestMapping("/api")
public class JobResource {
    ...
    public ResponseEntity<JobDTO> updateJob(@PathVariable(value = "id", required = false) final String id, @RequestBody JobDTO jobDTO)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, jobDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<JobDTO> partialUpdateJob(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, jobDTO.getId()));
    }
