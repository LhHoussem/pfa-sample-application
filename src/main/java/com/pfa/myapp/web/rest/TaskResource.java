...
/**
 * REST controller for managing {@link com.pfa.myapp.domain.Task}.
 */
@RestController
@RequestMapping("/api")
public class TaskResource {
     ...
     */
    @PutMapping("/tasks/{id}")
    public ResponseEntity<TaskDTO> updateTask(@PathVariable(value = "id", required = false) final String id, @RequestBody TaskDTO taskDTO)
    ...
    public ResponseEntity<TaskDTO> partialUpdateTask(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, taskDTO.getId()));
    }
